...
public class teleportingTest
{
    ...
    public void testHit(){
        ...
        Teleporting teleportingBlock = (Teleporting)dikuArcadeBiding.placeBlocks((0.2f,0.2f),(0.03f,0.04f),"brown-block.png",typeof(Teleporting),gameRunning);
        teleportingBlock.hit(100,gameRunning.getBalls[0]);
        int prevLength = gameRunning.getBlocks.Count();
        Assert.True(gameRunning.getBlocks.Count() == prevLength);
    }
