...
public class hungryTest
{
    ...
    public void testHit(){
        ...
        Hungry hungryBlock = (Hungry)dikuArcadeBiding.placeBlocks((0.2f,0.2f),(0.03f,0.04f),"brown-block.png",typeof(Hungry),gameRunning);
        hungryBlock.hit(100,gameRunning.getBalls[0]);
        Assert.True(gameRunning.getBalls.Last().Shape.Position.X == gameRunning.getPlayer.Shape.Position.X);
    }
}
